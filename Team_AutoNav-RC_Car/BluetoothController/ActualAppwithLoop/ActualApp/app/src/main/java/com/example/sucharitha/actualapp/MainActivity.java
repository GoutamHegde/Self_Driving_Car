...
public class MainActivity extends AppCompatActivity {
    ...
    KeepSending send;
   // KeepSendingStop sendstop;
   volatile String datatosend;
    ...
    public class KeepSending extends Thread{
        private static final String TAG3="KeepSending";
        ...
        public void run()
        {
            while(startflag) {
                if (connectedThread != null) {
                    ...
                    Log.d(TAG3, "Sending data ");
                } else {
                    Toast.makeText(getApplicationContext(), "Failed to send data in KeepSending Thread", Toast.LENGTH_SHORT).show();
                    Log.d(TAG3, "KeepSending Thread" + connectedThread);
                }
            }
        }
    }
    public class KeepSendingStop extends Thread{
        private static final String TAG3="KeepSending";
        private String data;

        public KeepSendingStop(String s)
        {
            data=s;
        }
        public void run()
