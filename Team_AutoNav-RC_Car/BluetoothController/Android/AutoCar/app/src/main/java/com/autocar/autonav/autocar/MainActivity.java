...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH)){
            Toast.makeText(this, "Bluetooth feature not supported", Toast.LENGTH_LONG).show();
            finish();
            return;
        }
        ...
        if (bluetoothAdapter == null) {
            Toast.makeText(this, "Bluetooth is not supported on this hardware", Toast.LENGTH_LONG).show();
            finish();
            return;
        }
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blueOnOff = (ToggleButton) findViewById(R.id.button5);
    ...
    */
    ...
    {
        if(resultCode==DISCOVER_DURATION && reqCode==REQUEST_BLUE){
            Intent intent= new Intent();
            intent.setAction(Intent.ACTION_SEND);
            intent.setType("text/plain");
            //File f= new File(Environment.getExternalStorageDirectory(),"md5Sum.txt");
            intent.putExtra(Intent.EXTRA_STREAM, Uri.encode("Hello Sending Signal"));
            ...
            if(appList.size()>0){
                ...
                for(ResolveInfo info:appList){
                    ...
                    if(packageName.equals("com.autocar.autonav.autocar")){
...
/*
    ...
    public void onResume() {
        ...
        BluetoothDevice device = blueAdp.getRemoteDevice(address);
...
*/
//---In DeviceListActivity.java-------//

//package com.autocar.autonav.autocar;

/**
 * Created by Karthikeya on 11/2/2016.
 */
/*
        import java.util.Set;
        import android.app.Activity;
