package com.example.sucharitha.AutoNav;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static String holdFlg="0",sendFlg="0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2=(Button) findViewById(R.id.DisableBT);
    ...
    public void receive()
    {
        ...
        if(connectedThread!=null)
        {
            ...
            status.setText("Receiving: Error");
    ...
    public void periodicSend(View v)
    {
        if(holdFlg=="0" && connectsuccess==1 && BA.isEnabled()==true)
        {
            send(v);
            startSend(v);
        }
    ...
    public class ConnectedThread extends Thread {
        ...
        public void read() {
            try {
                Log.d(TAG2,"In read block");
                mmInStream.read();
                TextView status=(TextView) findViewById(R.id.Status);
                ProgressBar statusProgressBar=(ProgressBar) findViewById(R.id.statusProgressBar);
                status.setText("Receiving: "+(char)mmInStream.read());
                statusProgressBar.setProgress((int)mmInStream.read());
            } catch (IOException e) { }
        }
